...
public class DbSeeder
{
    ...
    private async Task CreateUsersAsync()
    {
        ...
        // Create the "Admin" ApplicationUser account (if it does not already exist)
    ...
    private void CreateItems()
    {
        ...
        EntityEntry<Item> e1 = DbContext.Items.Add(new Item()
        {
            ...
            Text = @"Loosley based on Magic: The Gathering, the game lets you play against a computer opponent or another human being.
    ...
    /// <param name="createdDate">the item created date</param>
    /// <returns></returns>
    ...
    private Comment GetSampleComment(int n, int itemId, string authorId, DateTime createdDate)
    {
        return new Comment()
        {
            ...
            UserId = authorId,
            ParentId = null,
            Text = String.Format("Sample comment #{0} for the #{1}", n, itemId),
            CreatedDate = createdDate,
            LastModifiedDate = createdDate
        };
    }
