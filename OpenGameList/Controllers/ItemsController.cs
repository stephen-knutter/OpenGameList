...
namespace OpenGameList.Controllers
{
  ...
  public class ItemsController : Controller
  {
        ...
        /// ROUTING TYPE: attribute-based
        /// </summary>
        /// <returns>An array of a default number of Json-serialized objects
        /// respresenting the last inserted items.</returns>
        [HttpGet("GetLatest")]
        ...
        /// Json-serialized objects representing some randomly-picked items</returns>
        [HttpGet("GetRandom")]
